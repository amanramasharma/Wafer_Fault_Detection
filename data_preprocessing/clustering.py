...
class KMeansClustering:
    """
        This class will be used ot divide the data into clusters before training.
    ...
    def create_clusters(self,data,number_of_clusters):
        ...
        try:
            ...
            self.save_model = self.file_op.save_model(self.kmeans,"KMeans")  # saving the KMeans model to directory
                                                                             # passing 'Model' as the funtions need three parameters
            self.data['Clusters'] = self.y_kmeans  # create a new column in dataset for storing the clusters information
